 ...
 public class AntLabMain {
    ...
    public void printOutMessage() {
        ...
        String toPrint = 
		  ...
		  Person1 p1 = new Person1("Bryan");
		  toPrint += p1.toString("sbaek47");
		  //Person2 replace P2 with your name
		  //and gburdell with your gt id
		  Person2 p2 = new Person2("Young");
		  toPrint += p2.toString("yhu388");
		  //Person3 replace P3 with your name
		  //and gburdell3 with your gt id
		  Person3 p3 = new Person3("Yuqi Cao");
		  toPrint += p3.toString("ycao344");
          //Person4 replace P4 with your name
          //and gburdell4 with your gt id
          Person4 p4 = new Person4("Jingyang Sui");
          toPrint += p4.toString("jsui7");
